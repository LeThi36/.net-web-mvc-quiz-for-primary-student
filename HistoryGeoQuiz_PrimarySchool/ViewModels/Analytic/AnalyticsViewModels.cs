...
namespace HistoryGeoQuiz_PrimarySchool.ViewModels.Analytic
{
    public class QuestionAnalyticsViewModel
    {
        ...
        public List<StudentScoreViewModel> AllStudents { get; set; } = new List<StudentScoreViewModel>();
    ...
    public class StudentReportViewModel
    {
        ...
        public int TotalAttempts { get; set; }
        public int AverageTimeSeconds { get; set; }
        public string Evaluation { get; set; } = string.Empty; // Excellent, Good, etc.
        
        // Progress Data
        public List<AttemptHistoryViewModel> AttemptHistory { get; set; } = new List<AttemptHistoryViewModel>();
        
        // Skills / Topics Breakdown (Optional for now)
